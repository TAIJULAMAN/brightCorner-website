        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b border-neutral-200">
            <nav className="container mx-auto flex items-center justify-between py-4 px-5 md:px-0">
                ...
                <div className="hidden md:flex items-center gap-8">
                    <Link href="#manifesto" className="text-sm text-neutral-600 hover:text-neutral-900 transition">
                        MANIFESTO
                    </Link>
                    <Link href="#" className="text-sm text-neutral-600 hover:text-neutral-900 transition">
                        TECHNOLOGY
                    </Link>
                    <Link href="#access" className="text-sm text-neutral-600 hover:text-neutral-900 transition">
                        ACCESS
                    </Link>
                </div>
