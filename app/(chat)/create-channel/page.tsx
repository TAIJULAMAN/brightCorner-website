        ...
        <div className="flex-1 bg-neutral-50/30 overflow-y-auto">
            <div className="max-w-2xl mx-auto py-12 px-6">
                <div className="bg-white rounded-[32px] shadow-sm border border-neutral-100 overflow-hidden">
                    {/* Header */}
                    <div className="px-8 py-6 border-b border-neutral-100 flex items-center gap-4 relative">
                        <Button
                            variant="ghost"
                            size="icon-sm"
                            onClick={() => router.back()}
                            className="text-neutral-400 hover:text-neutral-600 rounded-xl"
                        >
                            <ChevronLeft size={20} />
                        </Button>
                        <h1 className="text-xl font-bold text-neutral-900 absolute left-1/2 -translate-x-1/2">Create Channel</h1>
                    </div>
                    ...
                    <div className="p-10 space-y-10">
                        ...
                        <div className="space-y-3">
                            ...
                            <Input
                                ...
                                className="h-14 bg-white border-neutral-100 rounded-2xl shadow-xs text-sm placeholder:text-neutral-300"
                            />
                        ...
                        <div className="space-y-3">
                            ...
                            <Textarea
                                ...
                                rows={4}
                                className="min-h-[120px] bg-white border-neutral-100 rounded-2xl text-sm placeholder:text-neutral-300 resize-none shadow-xs"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-1.5 bg-neutral-50 rounded-2xl flex items-center gap-1.5">
                                <Button
                                    ...
                                    className={`flex-1 h-12 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${privacy === 'public'
                                ...
                                <Button
                                    ...
                                    className={`flex-1 h-12 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${privacy === 'private'
                                        ? 'bg-cyan-400 hover:bg-cyan-500 text-white shadow-lg shadow-cyan-100 border-none'
                                        : 'text-neutral-400 hover:text-neutral-600 hover:bg-neutral-100/50 border-none'
                                        }`}
                                >
                        ...
                        {privacy === 'private' && (
                            <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
                                <div className="flex items-center justify-between px-1">
                                    ...
                                    <span className="text-[10px] text-neutral-400 font-medium">Require answers before joining</span>
                                </div>

                                <div className="space-y-6">
                                    {questions.map((q, qIndex) => (
                                        <div key={q.id} className="p-8 border border-neutral-100 rounded-3xl space-y-6 relative group bg-white shadow-xs">
                                            <Button
                                                variant="ghost"
                                                size="icon-sm"
                                                onClick={() => removeQuestion(q.id)}
                                                className="absolute top-4 right-4 text-neutral-300 hover:text-red-500 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-all rounded-lg"
                                            >
                                                <Trash2 size={16} />
                                            </Button>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-12 bg-neutral-50/50 border-neutral-100 rounded-xl focus:bg-white text-sm font-semibold"
                                                />
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="space-y-3">
                                                    {q.options.map((opt, oIndex) => (
                                                        <div key={oIndex} className="flex items-center gap-4 px-1">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="h-8 text-[11px] font-bold text-indigo-500 hover:text-indigo-600 hover:bg-indigo-50 flex items-center gap-1 rounded-lg"
                                                    >
                                    ...
                                    <Button
                                        variant="outline"
                                        onClick={addQuestion}
                                        className="w-full h-16 border-2 border-dashed border-indigo-100 rounded-2xl text-indigo-500 hover:bg-indigo-50/50 hover:border-indigo-200 transition-all font-bold text-sm flex items-center justify-center gap-2"
                                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border-2 border-dashed border-neutral-100 rounded-[32px] p-12 flex flex-col items-center justify-center text-center gap-4 hover:border-indigo-200 hover:bg-indigo-50/30 transition-all cursor-pointer group bg-white shadow-xs">
                        ...
                        <div className="pt-6 space-y-4">
                            <Button className="w-full h-16 bg-indigo-600 text-white rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 hover:shadow-indigo-200 active:scale-[0.98]">
                                Create Channel
                            </Button>
                            <Button
                                variant="ghost"
                                onClick={() => router.back()}
                                className="w-full h-12 text-neutral-400 hover:text-neutral-600 font-bold text-sm transition-colors rounded-xl"
                            >
                                Cancel
                            </Button>
                        </div>
